...
If you've created the virtual environment using `uv', you might get a **`No module named pip`** error when trying to upgrade pip.

In this happens, install and upgrade pip using the command below:
